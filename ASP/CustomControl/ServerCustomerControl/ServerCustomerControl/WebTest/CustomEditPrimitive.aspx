<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomEditPrimitive.aspx.cs"
    Inherits="CustomEditPrimitive" %>

<%@ Register Assembly="FirstCustomControl" Namespace="FirstCustomControl" TagPrefix="FC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Custom edit box, with primitive implementation </title>
    <style type="text/css">
        .style1
        {
            width: 100%;
...
<body>
    ...
    <table class="style1">
        ...
        <tr>
            <td colspan="2">
                <FC:CustomEditBoxPrimitive ID="CustomEditBoxPrimitive1" runat="server" Label="[Label]"
                    Text="[Text]" />
            </td>
        </tr>
        <tr>
