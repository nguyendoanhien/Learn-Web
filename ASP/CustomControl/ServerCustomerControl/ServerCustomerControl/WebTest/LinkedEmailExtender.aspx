<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkedEmailExtender.aspx.cs"
    Inherits="LinkedEmailExtender" %>

<%@ Register Assembly="FirstCustomControl" Namespace="FirstCustomControl" TagPrefix="FC" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Linked email extender</title>
</head>
<body>
    ...
    <br />
    <br />
    <FC:LinkedEmailExtender ID="LinkedEmailExtender1" runat="server"></FC:LinkedEmailExtender>
    <br />
    <br />
